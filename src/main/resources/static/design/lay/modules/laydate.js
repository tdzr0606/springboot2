...
;!function ()
{
    ...
    var isLayui = window.layui && layui.define, ready = {
        ...
        //字符常量  // TIPS_OUT = '开始日期超出了结束日期<br>建议重新选择',
        , MOD_NAME = 'laydate', ELEM = '.layui-laydate', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide',
        DISABLED = 'laydate-disabled',
        TIPS_OUT = ((lang == 'zh') ? '开始日期超出了结束日期<br>建议重新选择' : ((lang == 'en')
                                                                ? 'The start date exceeds the end date<br/>Recommend reselection'
                                                                : '')),
    ...
    */
    ...
    Class.prototype.lang = function ()
    {
        ...
        return text[lang] || text[options.lang] || text['cn'];
    };
    //初始准备
    ...
    Class.prototype.list = function (type, index)
    {
        ...
        { //时间列表
            ...
            var setTimeStatus = function ()
            {
                ...
                if (!options.range) that.limit(lay(that.footer).find(ELEM_CONFIRM), that[startEnd], 0,
            ...
            lay.each([24, 60, 60], function (i, item)
            {
                ...
                {
                    childUL.push('<li' + (that[startEnd][hms[i]] === ii ? ' class="' + THIS + '"' : '') + '>' + lay.digit(ii, 2) +
                                 '</li>');
                });
